...
public class SelectExampleLVL  extends AppCompatActivity implements View.OnClickListener  {
    private Button buttonLVL1, buttonLVL2;
    private Intent i;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.select_examplelvl_activity);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button1:
                i = new Intent(this, Example.class);
                startActivity(i);
                break;
            case R.id.button2:
                i = new Intent(this, ExampleLVL2.class);
                startActivity(i);
                break;
        }
    }
